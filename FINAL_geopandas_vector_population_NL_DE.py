...
eurostat_data = pd.read_csv(r'C:\Users\wald_\OneDrive\Dokumente\Hochschule der Medien\International_Projekt_Rituals_HvA_HdM\FINAL_NUT3_population_NL_DE_2019.csv', delimiter=';', encoding='ISO-8859-1')
...
folium.Choropleth(
    ...
    fill_opacity=0.7,
    line_opacity=0.2,
    legend_name='Population Structure NL&DE (2019)',
...
m.save("FINAL_rituals_avenda_store_map_with_vector_tiles_population_NL_DE_MAP.html")
